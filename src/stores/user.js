...
export const userStore = defineStore('user', {
    state: () => ({
        users: [
            { id: 1, username: 'Admin', tipo: 'admin', email: 'admin@gmail.com', datanascimento: '12-01-2002', password: 'Esmad_2223', morada: 'Avenida da Republica', localidade: 'Vila Nova de Gaia', postalCode: '4400-182', photo: 'https://picsum.photos/200/300', pontos: 50, medals: [], nºUtilizaçao: 2,ecopontosRegistados: 0, desafios: [], ranking: 1, diaSemana: 'Segunda-Feira'},
            { id: 2, username: 'User', tipo: 'userNormal', email: 'user@gmail.com', datanascimento: '12-01-2002', password: 'Esmad_2223', morada: 'Avenida da Republica', localidade: 'Vila Nova de Gaia', postalCode: '4400-182', photo: 'https://picsum.photos/200/300', pontos: 15, medals: [1], nºUtilizaçao: 2,ecopontosRegistados: 0, desafios: [], ranking: 2, diaSemana: 'Segunda-Feira'},
