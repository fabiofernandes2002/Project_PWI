...
export const ecopointStore = defineStore('ecopoint', { 
  state: () => ({
    ...
    ecopoints: [
        ...
        {id: 2, ecopointName: 'Ecopoint Green', userCreate: '2', ecopointLocation: 'Vila Nova de Gaia', ecopointAddress: 'Avenida da Republica', ecopointCreationDate: '2021-01-01', ecopointStatus: 'active', ecopointType: 'Glass', latitude: 41.362774699560454, longitude: -8.740214109420776},
        ...
        {id: 5, ecopointName: 'Ecopoint Red', userCreate: '5', ecopointLocation: 'Vila Nova de Gaia', ecopointAddress: 'Avenida da Republica', ecopointCreationDate: '2021-01-01', ecopointStatus: 'active', ecopointType: 'Battery', latitude: 41.351730, longitude: -8.747862},
